...
public class IntegerTupleColumn<E extends AbstractEntity,K> extends IntegerColumn<Tuple<K>> implements HasFetchPaths<E>
{
  private FetchPaths<E,Tuple<K>> _fetchPaths;
  private String _propertyKey;
  
  public IntegerTupleColumn(PropertyPath<E> propertyPath, String name, String description, String group)
  {
  ...
  @Override
  public Integer getCellValue(Tuple<K> tuple)
  {
    return (Integer) tuple.getProperty(_propertyKey);
  }
}
