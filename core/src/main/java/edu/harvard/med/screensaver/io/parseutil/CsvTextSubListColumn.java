...
public class CsvTextSubListColumn extends CsvSubListColumn<String>
{
  public CsvTextSubListColumn(String name, int col, boolean isRequired)
  {
    super(name, col, isRequired);
  }

  @Override
  protected String parseSubElement(String value)
  {
    return value;
  }
}