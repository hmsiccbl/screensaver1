...
public class BooleanTupleColumn<E extends AbstractEntity,K> extends BooleanColumn<Tuple<K>> implements HasFetchPaths<E>
{
  private FetchPaths<E,Tuple<K>> _fetchPaths;
  private String _propertyKey;
  
  public BooleanTupleColumn(PropertyPath<E> propertyPath, String name, String description, String group)
  {
  ...
  @Override
  public Boolean getCellValue(Tuple<K> tuple)
  {
    return (Boolean) tuple.getProperty(_propertyKey);
  }
}
