...
public abstract class ImageTupleColumn<E extends AbstractEntity,K> extends ImageColumn<Tuple<K>> implements HasFetchPaths<E>
{
  private FetchPaths<E,Tuple<K>> _fetchPaths;
  private String _propertyKey;
  
  public ImageTupleColumn(PropertyPath<E> propertyPath, String name, String description, String group)
  {
