...
public class VisibleTableColumnModelTest extends TestCase
{
  ...
  protected void setUp() throws Exception
  {
    ...
    _columns.add(new TableColumn<Row>("A", "") {
      @Override
      public Object getCellValue(Row row) { return row.a; }
      public boolean isVisible() { return _isVisible.get(getName()); }
    });
    _columns.add(new TableColumn<Row>("B", "") {
      @Override
      public Object getCellValue(Row row) { return row.b; }
      public boolean isVisible() { return _isVisible.get(getName()); }
    });
    _columns.add(new TableColumn<Row>("C", "") {
      @Override
      public Object getCellValue(Row row) { return row.c; }
      public boolean isVisible() { return _isVisible.get(getName()); }
    });
