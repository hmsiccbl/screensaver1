...
/**
 * Annotates an entity bean's property (on the getter method) as a one-to-many relationship
 * with another entity. Provides custom extensions for javax.persistence.OneToMany.
 * 
