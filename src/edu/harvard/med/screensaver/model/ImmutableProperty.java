...
/**
 * Annotates an entity bean's property (on the getter method) as immutable. Such
 * properties must be specified as constructor arguments and must have no
 * corresponding non-Hibernate setter method. 
 * 
