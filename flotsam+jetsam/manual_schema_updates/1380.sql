...
UPDATE gene SET gene_id_2 = cast(gene_id AS integer);
...
UPDATE silencing_reagent SET gene_id_2 = cast(gene_id AS integer);
...
UPDATE gene_old_entrezgene_id SET gene_id_2 = cast(gene_id AS integer);
...
UPDATE gene_old_entrezgene_symbol SET gene_id_2 = cast(gene_id AS integer);
...
UPDATE gene_genbank_accession_number SET gene_id_2 = cast(gene_id AS integer);
