			...
			<h:form id="navForm">
				<t:panelNavigation2 id="navMenu" layout="table" itemClass="menuItem"
					...
					<t:commandNavigation2 action="#{menu.findReagents}"
						value="Find Reagents" accesskey="R"
					...
					<t:commandNavigation2
						action="#{menu.browseScreeningRoomActivities}"
					...
					<t:commandNavigation2 action="#{menu.browseScreeners}"
						rendered="#{menu.readAdmin}" value="Browse Screeners"
						accesskey="U" title="Browse the screeners" />
					...
					<t:commandNavigation2 action="goEnvironmentInfo"
						value="Environment" visibleOnUserRole="developer"
