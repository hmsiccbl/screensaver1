...
<f:subview id="library">
  <h:form id="libraryForm">
    ...
    <h:panelGroup>
      <h:commandButton id="submitSave" action="#{library.save}" value="Save"
        rendered="#{library.usageMode == 'edit'}" />
      <h:commandButton id="submitCreate" action="#{library.create}" value="Create"
        rendered="#{library.usageMode == 'create'}" />
      ...
      <h:commandButton id="revertAction" immediate="true"
        actionListener="#{library.revertEventHandler}" value="Revert" />
      <h:commandButton id="showAdvancedAction" immediate="true"
        actionListener="#{library.showAdvancedEventListener}" value="Advanced"
        rendered="#{not Library.advancedMode}" />
      <h:commandButton id="showBasic" immediate="true"
        actionListener="#{library.showAdvancedEventListener}" value="Basic"
        rendered="#{library.advancedMode}" />
    </h:panelGroup>
