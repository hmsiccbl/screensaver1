    ...
    <t:panelGrid>
      ...
      <h:form id="dataForm" title="Screen Result Viewer">
        ...
        <h:panelGrid columns="1">
          ...
          <t:dataTable id="rawDataTable" binding="#{screenResultViewer.dataTable}" value="#{screenResultViewer.rawData}" var="row" rows="10" rendered="#{screenResultViewer.showRawDataTable}" styleClass="standardTable" headerClass="tableHeader"
      ...
      <h:form id="navigationForm">
        <h:panelGroup rendered="#{screenResultViewer.showRawDataTable}">
          ...
          <h:inputText id="firstDisplayedRowNumber" value="#{screenResultViewer.firstDisplayedRowNumber}" binding="#{screenResultViewer.firstDisplayedRowNumberInput}" valueChangeListener="#{screenResultViewer.firstDisplayedRowNumberListener}" size="6"
            styleClass="input">
