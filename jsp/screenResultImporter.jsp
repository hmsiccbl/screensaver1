    ...
    <t:panelGrid>
      ...
      <h:form id="commandForm">
        <h:panelGroup>
          ...
          <h:commandButton id="downloadCommand" actionListener="#{screenResultImporter.downloadErrorAnnotatedWorkbookListener}" value="Download Error-Annotated Workbook" rendered="#{screenResultImporter.screenResultParser.hasErrors}" styleClass="command" />
        </h:panelGroup>
      </h:form>
      ...
      <h:form id="errorsTableForm" rendered="#{screenResultImporter.screenResultParser.hasErrors}">
        ...
        <t:dataScroller id="errorsScroller" for="importErrorsTable" firstRowIndexVar="fromRow" lastRowIndexVar="toRow" rowsCountVar="rowCount" paginator="true" paginatorMaxPages="10" fastStep="10" renderFacetsIfSinglePage="true" styleClass="scroller"
