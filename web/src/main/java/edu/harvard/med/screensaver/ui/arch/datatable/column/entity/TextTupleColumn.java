...
public class TextTupleColumn<E extends AbstractEntity,K> extends TextColumn<Tuple<K>> implements HasFetchPaths<E>
{
  private FetchPaths<E,Tuple<K>> _fetchPaths;
  private String _propertyKey;
  
  public TextTupleColumn(PropertyPath<E> propertyPath, String name, String description, String group)
  {
  ...
  { 
    Object o = tuple.getProperty(_propertyKey);
