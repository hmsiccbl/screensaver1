 ...
 */
public class VocabularyConverter<V> implements Converter
{
  private static Logger log = Logger.getLogger(VocabularyConverter.class);

  private Map<NormalizedString,V> string2Enum = new HashMap<NormalizedString,V>();

  public VocabularyConverter(Collection<V> values)
  {
  ...
  public VocabularyConverter(V... values)
  {
    for (V value : values) {
