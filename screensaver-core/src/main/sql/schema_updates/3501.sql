...
/* TODO: Delete any attached file types that are not used being by
your facility.  You may also add new ones, as desired.  If you are
using ICCB-L-specific attached file types for some reason, reinstate
