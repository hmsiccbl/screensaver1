...
3. commands are separated by semicolons (';') thar occur at the end of a line. no exceptions.
4. if any errors are encountered, then initialization abruptly halts. any uncommitted changes
