...
<f:subview id="naturalProductsLibraryContentsImporter">

  <h:panelGroup>
    <%@include file="naturalProductsLibraryContentsUploader.jspf"%>
  </h:panelGroup>

  <h:form id="errorsTableForm" rendered="#{naturalProductsLibraryContentsImporter.hasErrors}">

    <h:outputText value="Import Errors for #{naturalProductsLibraryContentsImporter.uploadedFile.name}"
      styleClass="sectionHeader" />

    <t:dataTable id="importErrorsTable" value="#{naturalProductsLibraryContentsImporter.importErrors}" var="row"
