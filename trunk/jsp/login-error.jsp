...
<f:subview id="login">
  <h:form id="loginErrorForm">
    ...
    <t:panelGrid columns="1">
      <t:commandButton value="Try again" action="#{menu.viewMain}" styleClass="command"/>
      <t:commandLink value="Forgot your user ID or password?" action="#{menu.forgotIdOrPassword}"
        styleClass="command" />
    </t:panelGrid>
  </h:form>
</f:subview>
