...
public class ReagentsDataModelTest extends AbstractSpringPersistenceTest
{
  // static members
...
//    });
  ...
  {
    ReagentsDataModel dataModel = new ReagentsDataModel(_study, 10, _study.getReagents().size(), null, null, genericEntityDao);
    doTestSortForAllColumnsAndDirections(dataModel);
  }

  public void testArbitrarySetReagentsDataModel()
  {
    ReagentsDataModel dataModel = new ReagentsDataModel(_study.getReagents(), 10, _study.getReagents().size(), null, null, genericEntityDao);
    doTestSortForAllColumnsAndDirections(dataModel);
  }
