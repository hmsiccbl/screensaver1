...
insert into attached_file_type (for_entity_type, attached_file_type_id, value) values ('screen', nextval('attached_file_type_id_seq'), 'Publication');
insert into attached_file_type (for_entity_type, attached_file_type_id, value) values ('screen', nextval('attached_file_type_id_seq'), 'Study-File');
